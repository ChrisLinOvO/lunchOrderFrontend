...
$icon-font-path: "//at.alicdn.com/t/font_1533967_v7yt00nd1pa";
...
$switch-hover-off-bg-color: #F9F9F9;

$switch-disabled-off-bg-color: #FAFAFA;
...
$switch-handle-disabled-border-color: #EEEEEE;
...
$switch-normal-off-border-color: #DDDDDD;

$switch-hover-off-border-color: #DDDDDD;
...
$nav-secondary-item-opened-bg-color: #1274E7;
...
$nav-normal-item-opened-bg-color: #F9F9F9;
